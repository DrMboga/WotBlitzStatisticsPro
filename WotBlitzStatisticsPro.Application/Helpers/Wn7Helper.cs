namespace WotBlitzStatisticsPro.Application.Helpers
{
    public static class Wn7Helper
    {
        ...
        public static void CalculateWn7(this TankInfoDto tank)
		{
            if (tank.Battles == 0)
            {
                return;
			...
			tank.Wn7 = CalculateWn7(tank.Battles, tank.Tier, avdFrags, avgDamage, avgSpot, avgDef, winRate);
		}
        
		public static void CalculateWn7(this PlayerInfoDto? account)
		{
            if (account == null || account.Battles == 0)
            {
                return;
            }
			...
			account.Wn7 = CalculateWn7(account.Battles, account.AvgTier ?? 0, avdFrags, avgDamage, avgSpot, avgDef, winRate);
		}
