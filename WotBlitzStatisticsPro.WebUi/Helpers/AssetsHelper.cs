namespace WotBlitzStatisticsPro.WebUi.Helpers
{
    public static class AssetsHelper
    {
        ...
        public static string ModuleAsset(this string moduleType)
        {
            return moduleType switch
            {
                Constants.VehicleModuleEngine => "modules/encyclopedia.vehicle.engine.scale-200.png",
                Constants.VehicleModuleTurret => "modules/encyclopedia.vehicle.turret.scale-200.png",
                Constants.VehicleModuleGun => "modules/encyclopedia.vehicle.gun.scale-200.png",
                Constants.VehicleModuleChassis => "modules/encyclopedia.vehicle.suspension.scale-200.png",
                _ => ""
            };
        }
    }
